...
The assembled view (stitched-together stream data packets) should be the default view, (a user who needs to see individual parts for e.g. debugging can always opt to do so).
